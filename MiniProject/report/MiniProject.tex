...
% Paragraph formatting: first-line indent, no extra paragraph spacing
\setlength{\parindent}{2em}
\setlength{\parskip}{0pt}

% Automatic word count via texcount
\newcommand{\wordcount}{
\immediate\write18{texcount -1 -sum -merge MiniProject.tex > wordcount.txt}
\input{wordcount.txt}
}
...
\begin{titlepage}
    ...
    {\large Imperial College London}\\[0.3cm]
    {\large rhh925@ic.ac.uk}\\[1cm]

    {\large Word count: \wordcount}\\[2cm]
